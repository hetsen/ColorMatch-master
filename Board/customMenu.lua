...
function scene:create(e)
	...
	local headline = display.newText(mainFrameGroup, 'Custom Levels', 0, 0, systemfont, _G.mediumLargeFontSize)
	...
	local function showButtons()
		local listOfButtons = {
			{name = 'Play', path = 'menu'},
			{name = 'Create', path = 'editor'},
			{name = 'Share', path = 'shareMenu'},
		} -- görs manuellt för att corona drygar sig
